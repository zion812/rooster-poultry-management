...
data class AuctionListing(
    ...
    val location: String,
    val category: String,
    // Enhanced auction mechanics
    val customDurationHours: Int, // 1-168 hours (7 days max)
    val minimumBidPrice: Double, // Seller-controlled minimum bid
    val requiresBidderDeposit: Boolean,
    val bidderDepositPercentage: Double, // 5-25% as mentioned in TODO
    val allowsProxyBidding: Boolean,
    val sellerBidMonitoring: BidMonitoringCategory,
    val autoExtendOnLastMinuteBid: Boolean,
    val extensionMinutes: Int, // Auto-extend duration
    val buyNowPrice: Double?, // Optional buy-it-now price
    val watchers: Int, // Number of users watching the auction
)
...
data class EnhancedAuctionBid(
    ...
    val proxyMaxAmount: Double?, // For proxy bidding
    val depositAmount: Double?, // If deposit was required
    val depositStatus: DepositStatus?,
    val bidStatus: BidStatus,
    val bidMessage: String?,
    val bidderRating: Double, // Bidder's platform rating
    val previousBidCount: Int, // Bidder's previous bid count on this auction
)
...
// Post-auction flow models
data class AuctionWinner(
    val auctionId: String,
    val winnerId: String,
    val winnerName: String,
    val winningBid: Double,
    val paymentDeadline: Date, // 10-minute payment window
    val paymentStatus: AuctionPaymentStatus,
    val backupBidders: List<BackupBidder>, // Next bidders in line
)
