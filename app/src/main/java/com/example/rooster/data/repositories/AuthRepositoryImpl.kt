...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun verifyOtp(phoneNumber: String, otp: String): Result<ParseUser> {
    ...
    override suspend fun login(phoneNumber: String, password: String): Result<ParseUser> {
