...
@Singleton
class FirebaseStorageImageUploadService
    @Inject
    constructor(
        ...
        override suspend fun uploadImages(
            ...
            withContext(Dispatchers.IO) {
                ...
                try {
                    ...
                    Timber.e(e, "Failed to upload images to Firebase Storage")
                    Result.Error(e)
                }
            }
        ...
        private fun getCompressedInputStream(
            ...
            originalInputStream.use { inputStream ->
                ...
                val scaleFactor =
                    if (originalWidth > originalHeight && originalWidth > options.maxWidthOrHeight) {
