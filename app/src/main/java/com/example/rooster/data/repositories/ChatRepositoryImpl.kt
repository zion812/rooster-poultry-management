...
class ChatRepositoryImpl
    ...
    constructor() : ChatRepository {
        ...
        override suspend fun createMessage(
            ...
            try {
                val messageParse = MessageParse().apply {
                    this.chatId = chatId
        ...
        override suspend fun getMessages(chatId: String): List<Message> = withContext(Dispatchers.IO) {
            try {
        ...
        override suspend fun getChats(userId: String): List<Chat> = withContext(Dispatchers.IO) {
            try {
        ...
        override suspend fun markMessagesAsRead(chatId: String) = withContext(Dispatchers.IO) {
            try {
                val query = ParseQuery.getQuery(MessageParse::class.java)
                query.whereEqualTo("chatId", chatId)
