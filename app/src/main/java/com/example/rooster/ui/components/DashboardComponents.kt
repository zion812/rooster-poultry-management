...
object DashboardHelper {
    ...
    fun getDefaultMetrics(role: DashboardRole, isTeluguMode: Boolean): List<DashboardMetric> {
        return when (role) {
    ...
    private fun getFarmerMetrics(isTeluguMode: Boolean): List<DashboardMetric> = listOf(
        DashboardMetric(
            title = "Total Birds",
    ...
    private fun getVetMetrics(isTeluguMode: Boolean): List<DashboardMetric> = listOf(
        DashboardMetric(
    ...
    private fun getBuyerMetrics(isTeluguMode: Boolean): List<DashboardMetric> = listOf(
        DashboardMetric(
            title = "Active Orders",
    ...
    private fun getAdminMetrics(isTeluguMode: Boolean): List<DashboardMetric> = listOf(
        DashboardMetric(
            title = "Total Users",
    ...
    fun getRecentAlerts(role: DashboardRole, isTeluguMode: Boolean): List<DashboardAlert> {
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Row(
                    ...
                    Icon(
                        imageVector = when (metric.trendDirection) {
                        ...
                        contentDescription = null,
                        tint = when (metric.trendDirection) {
