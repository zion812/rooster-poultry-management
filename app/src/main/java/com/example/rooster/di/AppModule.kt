...
import com.example.rooster.core.auth.datasources.UserDataSource // Import UserDataSource interface
...
import com.example.rooster.data.datasources.firebase.FirebaseUserDataSource // Import FirebaseUserDataSource impl
...
abstract class AuthBindsModule {
    ...
    @Binds
    @Singleton
    abstract fun bindUserDataSource(impl: FirebaseUserDataSource): UserDataSource // Added binding
}
