...
class RealTimeMessagingService
    ...
    constructor(
        ...
        private fun createMessagingWebSocketListener() =
        ...
        private fun sendDeliveryConfirmation(
            messageId: String,
            chatId: String,
        ) {
            if (!isConnected) return
        ...
        private fun generateMessageId(): String = "MSG_${System.currentTimeMillis()}_${(1000..9999).random()}"
