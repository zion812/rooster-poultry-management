...
class EnhancedFarmManagementScreenTest {
    ...
    fun allButtons_navigateOrActCorrectly() {
        composeTestRule.setContent {
            ...
            NavHost(navController, startDestination = NavigationRoute.EnhancedFarmManagement.route) {
                composable(NavigationRoute.EnhancedFarmManagement.route) { EnhancedFarmManagementScreen(navController) }
        ...
        assert(composeTestRule.navController.currentBackStackEntry?.destination?.route == NavigationRoute.FarmFlockList.route)
