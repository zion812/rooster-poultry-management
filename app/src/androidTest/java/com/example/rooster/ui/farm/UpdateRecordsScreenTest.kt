...
class UpdateRecordsScreenTest {
    ...
    fun allButtons_navigateOrActCorrectly() {
        composeTestRule.setContent {
            ...
            NavHost(navController, startDestination = NavigationRoute.UpdateRecords.route) {
                composable(NavigationRoute.UpdateRecords.route) { UpdateRecordsScreen(navController) }
        ...
        // Example assertion; adjust based on actual navigation after update
