...
class AuctionListingScreenTest {
    @get:Rule
    ...
    fun allButtons_navigateOrActCorrectly() {
        composeTestRule.setContent {
            ...
            NavHost(navController, startDestination = NavigationRoute.AuctionListing.route) {
                composable(NavigationRoute.AuctionListing.route) { AuctionListingScreen(navController) }
        ...
        // Example assertion; adjust based on actual navigation after clicking view details
