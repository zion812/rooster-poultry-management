...
class FirebaseStorageImageUploadServiceTest {
    ...
    @Test
    fun `uploadImage openInputStream fails`() = runTest {
        val mockUri = mockk<Uri>()
    ...
    @Test
    fun `uploadImage putStream fails`() = runTest {
        val mockUri = mockk<Uri>()
    ...
    @Test
    fun `uploadImages success multiple URIs`() = runTest {
    ...
    @Test
    fun `uploadImages empty list returns success empty list`() = runTest {
