...
// FirebaseMarketplaceDataSource will be replaced by ParseMarketplaceDataSource
import com.example.rooster.feature.marketplace.data.remote.ParseMarketplaceDataSource // Import Parse Impl
...
abstract class MarketplaceBindsModule {
    ...
    abstract fun bindMarketplaceRemoteDataSource(
        impl: ParseMarketplaceDataSource // Bind Parse implementation
